...
public class SixthScreen extends BaseRoomScreen{
    ...
    public SixthScreen(Game myGdxGame) {
        super(myGdxGame);
        gravity = -20f;
    ...
    public void show() {
        ...
        TiledMap tiledMap = loader.load("tiledmap1/SamsungMap4.tmx");
